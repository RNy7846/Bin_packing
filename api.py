...
def getAllItemAndBoxAPI():
    if flask.request.method == "POST":
        ...
        return {"Sucesso": False,"Razão":"Não pode usar GET"}
        return res
...
def mkResultAPI():
    ...
    if flask.request.method == "POST":
        ...
        if 'box' in q.keys() and 'item' in q.keys() and 'binding' in q.keys():
            ...
            res['Reason'] = 'Caminhão ou Caixa não foram inseridos'
            return res
    else :
        res['Reason'] = 'Method != POST'
        return res
...
if __name__ == "__main__":
    ...
    2. Retornar o item escolhido
    3. Retorna o resultado
    '''

    # start the web server
    print("* Iniciando Web Service...")
